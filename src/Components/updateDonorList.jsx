...
const UpdateDonor = ({ showTableUD, donors, setDonors }) => {
    ...
    <div className={`donors_list_Update_Table ${showTableUD ? "" : "hidden hide"}`}>
      {donors.length > 0 ? (
        ...
        >
          ...
          >
            <tr>
              <th style={{ border: "1px solid lightgray", padding: "20px" }}>UPDATE</th>
              <th style={{ border: "1px solid lightgray", padding: "15px" }}>NAME</th>
              <th style={{ border: "1px solid lightgray", padding: "15px" }}>PHONE NUMBER</th>
              <th style={{ border: "1px solid lightgray", padding: "15px" }}>BLOOD GROUP</th>
              <th style={{ border: "1px solid lightgray", padding: "15px" }}>CITY</th>
              <th style={{ border: "1px solid lightgray", padding: "15px" }}>DELETE</th>
            </tr>
          </thead>
          <tbody>
            {donors.map((donor) => (
